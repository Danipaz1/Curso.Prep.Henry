...
function eliminarPropiedad(objeto, propiedad) {
  ...
  delete objeto.eliminarPropiedad;
  return objeto;
}
...
function nuevoUsuario(nombre, email, password) {
  ...
  // Tu código:
  var nuevoUsuario = {
    nombre: 'Daniela Velásquez',
    email: 'dn.velasquezdevia@gmail.com',
    password: 'daniela'
  };
    return nuevoUsuario;
}
...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  var usuario = {
    amigos: ['pablo', 'carepoto', 'noentiendoniwea']
  }
...
function sumarLikesDeUsuario(usuario) {
  ...
  var suma = 0;
  for(var i = 0; i < usuario.post.lrngth; i++) {
